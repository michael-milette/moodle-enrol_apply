...
/**
 * Process expirations task — suspends or unenrols users whose enrolment has expired.
 */
class process_expirations extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('processexpirationstask', 'enrol_apply');
    }

    /**
     * Run task for processing enrolment expirations.
     */
